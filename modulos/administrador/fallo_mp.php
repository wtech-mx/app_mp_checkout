          ...
          <div class="col-lg-4 col-md-7">
            <div class="card border-0 mb-0">
              <div class="card-header bg-transparent">
                  ...
                  <h5 class="text-dark text-center mt-2 mb-3">Error al realizar el pago</h5>

                  <p class="text-center">
                      <img src="./img/cancelar.png" alt="" style="width: 60px">
                  </p>
              ...
              <div class="card-body px-lg-5 pt-0">
                ...
                <div class="text-center text-muted mb-4">
                    <a class="btn btn-primary" href="./licencias_old.php">
                        Regresar al inicio
                    </a>
                </div>
