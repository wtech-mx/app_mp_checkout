<?php 
    ...
    <head>
        ...
        <script type="text/javascript" src="'.$PROF.'js/jquery-1.10.2.min.js"></script>
        <script type="text/javascript" src="'.$PROF.'js/alertify.js"></script>
        ...
        <link type="text/css" href="css/estilos.css?v=1.0.43" rel="stylesheet" >
    </head>
    <body>';